...
### Work I Have Done and What I Have Learned

As I alluded earlier, a lot of my time was spent compiling the data in a way that allowed me to manipulate it in a way that I could use for the story I wanted to tell and the visualizations I wanted to show. Because of that, I learned that I needed to either narrow the scope of any future projects ahead of collecting the data, or to rely on data sets that are widely accessible or require less manipulation/joining in general. At the same time, though, I discovered some of my most interesting insights by manually typing in the director data for each best picture nominee separately: this is when it became evident to me that there were more female directors for Best Picture nominees than there were female directors who were nominated for Best Picture. I am not sure whether I would have come to the same conclusion if the data were more easily available, and I would not have had to search for each director individually.

This is rather obvious, and it is something that I have had reinforced throughout the course, but I often could think of the "perfect" way to represent data in a sketch, but when it came time to add it to Tableau, Data Wrapper, or Raw Graphs, I was not able to manipulate or translate it exactly as I wanted. Or, more often, I found that I was attempting to get far too much information into a single chart. This is certainly a useful lesson to learn. If I cannot create something as I imagine, then I need to narrow the focus until I can create it. On a few occasions, this caused me to create multiple charts that I had initially conceived of as a single chart. An example of this is the bar charts comparing *Titanic*, *The Avengers*, and *The Hurt Locker.* I originally wanted the box office and awards comparisons in a single chart, but when I had to break it into two, it actually helped me tell the story a bit better. On a similar note, I originally tried to plot my scatter plot (chart titled "Titanic Is in a Class of Its Own, But There Are Other Standouts"), but was unable to manipulate the chart in a way that included that information. Ultimately, I am glad I had this limitation. The year was not relevant to what I was trying to say about the relationship between Oscar wins and box office earnings.

A few other quick lessons from design decisions I made:

1. Alluvial diagrams are great if you have dichotomous (or close to dichotomous) categories. Anything more than that, and they lose their impact and intuitiveness.
2. Sometimes the best way to visualize something is by simply bolding it in a paragraph. I had attempted to put the percentage summary statistics in a table, but it just was not necessary. I still wanted to highlight the relevant information, though, and the bolding goes a long way.
3. Color blocking the background helped break up the monotony of the page, and it allowed me to highlight the key findings and conclusions.
